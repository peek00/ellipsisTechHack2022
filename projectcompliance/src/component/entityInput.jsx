    ...
    return(
        <div>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <br></br>
                Service<input type='text' name='service' onChange={onServiceChange}/>
            ...
            <div className="info">
                <h2>Service Borrowed</h2>
                    <ul>
                        {serviceBorrowed.length? serviceBorrowed.map(service => (<li key={service}>{service}</li>)) : <span></span>} 
                    </ul>
                <h2>Service Offered</h2> 
                    <ul>
                        {serviceOffered.length? serviceOffered.map(service => (<li key={service}>{service}</li>)) : <span></span>}
                    </ul>
            </div>
